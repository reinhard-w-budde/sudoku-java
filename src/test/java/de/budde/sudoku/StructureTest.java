...
public class StructureTest {
	...
	public void testNeighbarHood() {
		...
		check(0, structure, ia(0, 1, 2, 3, 4, 5, 6, 7, 8), ia(0, 9, 18, 27, 36, 45, 54, 63, 72),
				ia(0, 1, 2, 9, 10, 11, 18, 19, 20));
		check(40, structure, ia(36, 37, 38, 39, 40, 41, 42, 43, 44), ia(4, 13, 22, 31, 40, 49, 58, 67, 76),
				ia(30, 31, 32, 39, 40, 41, 48, 49, 50));
		check(Cell.xy2idx(4, 1), structure, ia(0, 1, 2, 3, 4, 5, 6, 7, 8), ia(3, 12, 21, 30, 39, 48, 57, 66, 75),
				ia(3, 4, 5, 12, 13, 14, 21, 22, 23));
	}
